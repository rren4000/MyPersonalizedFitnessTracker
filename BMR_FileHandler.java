            ...
            try (BufferedReader br = new BufferedReader(new FileReader(file))) {
                ...
                while ((line = br.readLine()) != null) {
                    if (line.startsWith("Age:")) {
                        profileData[0] = Integer.parseInt(line.split(":")[1].trim());
                    } else if (line.startsWith("Weight:")) {
                        profileData[1] = Integer.parseInt(line.split(":")[1].trim());
                    } else if (line.startsWith("Height:")) {
                        profileData[2] = Integer.parseInt(line.split(":")[1].trim());
                    }
                }
            } catch (IOException e) {
                e.printStackTrace();
            ...
            try (BufferedReader br = new BufferedReader(new FileReader(file))) {
                ...
                while ((line = br.readLine()) != null) {
                    if (line.startsWith("Goal Weight (in pounds):")) {
                        goalWeight = Integer.parseInt(line.split(":")[1].trim());
                    }
                }
            } catch (IOException e) {
                e.printStackTrace();
